    ...
    <footer className="mt-12 border-t bg-background">
      <div className="container px-6 py-12 mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row md:items-start md:justify-start gap-8">
          <div className="flex flex-col items-start gap-2">
            <Image
              ...
              priority
            />
            <span className="text-muted-foreground text-md my-1">Cashback, finally done right.</span>
            <ThemeToggle />
          </div>

          <div className="flex flex-wrap max-w-3xl gap-8 md:justify-center md:flex-1">
        ...
        <div className="pt-8 mt-8 border-t flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="text-md text-muted-foreground text-right min-w-[220px] flex flex-col items-end justify-between gap-2">
